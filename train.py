...
parse.add_argument('--image_folder', type=str, default='/home/aistudio/data/data68698')
parse.add_argument('--image_list_file', type=str, default='/home/aistudio/data/data68698/train_list.txt')
